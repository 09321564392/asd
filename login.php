...
<body>
    ...
    <i class="fa fa-music one" aria-hidden="true"></i>
    </div>
    <i class="fa fa-music one-one" aria-hidden="true"></i>
    </div>
    <i class="fa fa-music two" aria-hidden="true"></i>
    </div>
    <i class="fa fa-music two-two" aria-hidden="true"></i>
    </div>
</body>
